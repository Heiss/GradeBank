...
/**
 * The Class ViewTeacherAddEdit.
 */
public class ViewTeacherAddEdit extends AbstractModelView {
	...
	/**
	 * Instantiates a new view teacher add edit.
	 */
	public ViewTeacherAddEdit() {
		super();
