...
/**
 * The Class ViewGradesAddEdit.
 */
public class ViewCourseGradesAddEdit extends AbstractModelView {
	...
	/**
	 * Instantiates a new view grades add edit.
	 */
	public ViewCourseGradesAddEdit() {
		super();
		this.setTitle(I18n.get().grade());
